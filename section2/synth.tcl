...
# !Do the above chparam for N_PIPES and N_DEPTH 


# Now, we set hierarchy
hierarchy -top asqrt_top
# !Here, insert the synthesis and techmapping script we used in Section 1, starting from the flatten command and ending with opt_clean
